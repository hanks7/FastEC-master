...
public class AutoPhotoLayout extends LinearLayoutCompat {
    ...
    public AutoPhotoLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        @SuppressLint({"CustomViewStyleable", "Recycle"}) final TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.camera_flow_layout);
    ...
    private void createNewImageView() {
        mTargetImageView = new AppCompatImageView(mDelegate.getContext());
