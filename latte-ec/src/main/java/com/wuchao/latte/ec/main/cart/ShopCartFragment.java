...
public class ShopCartFragment extends BottomItemFragment implements ICartItemListener, IAlPayResultListener {
        ...
        RxRestClient.builder()
                ...
                .subscribe(new Consumer<String>() {
                    ...
                    public void accept(String response) throws Exception {
                        ...
                        mAdapter.setCartItemListener(ShopCartFragment.this);
